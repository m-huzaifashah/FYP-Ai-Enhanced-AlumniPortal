...
export default function JoinCards({ items, onNavigate, image }: { items: { title: string; go: string; desc?: string }[]; onNavigate: (route: string) => void; image: string }) {
  return (
    <div className="rounded-3xl bg-indigo-50 px-6 py-10 md:px-10 md:py-14" style={{ backgroundImage: 'radial-gradient(24rem_24rem at 20% 10%, rgba(0,0,0,0.03) 0, rgba(0,0,0,0.0) 60%), radial-gradient(20rem_20rem at 80% 60%, rgba(0,0,0,0.03) 0, rgba(0,0,0,0.0) 55%)' }}>
