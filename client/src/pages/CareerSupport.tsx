    ...
    <div className="min-h-screen bg-light-section py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-lg text-primary max-w-2xl mx-auto">
              ...
              <div className="bg-white p-6 rounded-xl">
                ...
                <div className="flex flex-wrap gap-2">
                  {(result.matched_skills || []).map((s: string) => (
                    <span key={s} className="px-2 py-1 bg-secondary text-primary rounded-md text-sm font-medium border border-green-200">
                      {s}
                    </span>
                  ))}
                </div>
