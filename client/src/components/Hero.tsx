...
export default function Hero({ onNavigate }: { onNavigate: (route: 'contact' | 'events') => void; image?: string }) {
  ...
  return (
    <div className="relative w-screen left-[50%] right-[50%] -ml-[50vw] h-[600px] overflow-hidden -mt-8 mb-[-80px]">
          ...
          <Reveal delay={200}>
            <div className="mt-12 flex flex-col sm:flex-row items-center justify-center gap-6">
              <button
                ...
                className="group relative flex items-center justify-center gap-2 rounded-xl bg-primary px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-black/20 transition-all hover:-translate-y-1 hover:scale-105 hover:bg-primary/90"
              >
                <span>About Us</span>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#F0F6FF] to-transparent" />
    </div>
  )
}
